  ...
  if (course === 'Design and Implementation of Human-Computer Interfaces') {
    switch (week) {
      ...
      case 'Week 5':
        content = (
          <ol>
            <li>a. User control and error correction</li>
            <li>a. True</li>
            <li>a. Cognitive walkthrough, c. Heuristic evaluation</li>
            <li>d. 10</li>
            <li>a. 3</li>
            <li>d. System Usability Scale</li>
            <li>a. After-Scenario Questionnaire</li>
            <li>b. False</li>
            <li>a. True</li>
            <li>b. heuristics/li>
            {/* Add more items as needed */}
